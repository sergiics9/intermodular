<?php
$title = 'Categoría: ' . htmlspecialchars($categoria->nombre);
?>
...
<div class="container mt-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?= BASE_URL ?>/categorias/index.php">Categorías</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <?php if (!empty($categoria->descripcion)): ?>
                <p class="lead"><?= htmlspecialchars($categoria->descripcion) ?></p>
            <?php endif; ?>
        </div>
    </div>
